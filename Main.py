...
def main():
    ...
    # --- Demonstriert nun den Abruf und die Entschlüsselung ---
    ...
    if password_data:
        ...
        # Schritt 6: Schlüssel für die Entschlüsselung wieder anpassen
        key_for_decryption = key_from_db - 3
        
        # Schritt 7: Passwort entschlüsseln
        decrypted_password = decryption.decryption(encrypted_password_from_db, key_for_decryption)
        
        # Schritt 8: Ausgabe der entschlüsselten Informationen
